...
namespace flowsa\captcha\widgets;

use flowsa\captcha\Captcha;
use flowsa\captcha\assetbundles\captchawidgetwidget\CaptchaWidgetWidgetAsset;
...
class CaptchaWidget extends Widget
{
    ...
    {
        return Craft::t('captcha', 'CaptchaWidget');
    }
    ...
    {
        return Craft::getAlias("@flowsa/captcha/assetbundles/captchawidgetwidget/dist/img/CaptchaWidget-icon.svg");
    }
    ...
    public function getSettingsHtml(): ?string
    {
        return Craft::$app->getView()->renderTemplate(
            'captcha/_components/widgets/CaptchaWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(CaptchaWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'captcha/_components/widgets/CaptchaWidget_body',
            [
